...
from src.domain.base.resource_manager import (
    ResourceManagerPort, ResourceSpecification, ResourceAllocation, ResourceType, ResourceId
)
...
class AWSResourceManagerAdapter(CloudResourceManagerPort):
    ...
    def list_available_resources(self, resource_type: Optional[str] = None, region: Optional[str] = None) -> List[Dict[str, Any]]:
        """
