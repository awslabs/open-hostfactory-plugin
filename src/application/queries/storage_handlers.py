...
from src.application.dto.system import StorageStrategyListResponse, StorageHealthResponse, StorageMetricsResponse
        ...
        for storage_type in storage_types:
            ...
            if query.include_details:
                ...
                strategy_info.update({
                    ...
                    "capabilities": registry.get_strategy_capabilities(storage_type) if hasattr(registry, 'get_strategy_capabilities') else []
                })
