...
class TestStorageRegistryIntegration:
    ...
    def test_repository_factory_uses_storage_registry(self):
        ...
        with patch('src.infrastructure.utilities.factories.repository_factory.get_storage_registry') as mock_get_registry, \
             patch('src.infrastructure.persistence.repositories.request_repository.RequestRepository') as mock_repo_class:
            ...
            mock_registry.create_strategy.assert_called_once_with("json", mock_config_manager.get_app_config.return_value)
    ...
    def test_di_container_uses_repository_factory(self):
        ...
        with patch('src.infrastructure.persistence.registration.register_all_storage_types'), \
             patch('src.infrastructure.utilities.factories.repository_factory.RepositoryFactory') as mock_factory_class:
    ...
    def test_end_to_end_repository_creation(self):
        ...
        with patch('src.infrastructure.persistence.repositories.request_repository.RequestRepository') as mock_repo_class:
            mock_repo_class.return_value = mock_repository
