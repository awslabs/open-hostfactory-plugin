    ...
    def _get_current_state(self, current_time: float) -> CircuitState:
        ...
        if current_state == CircuitState.OPEN:
            ...
            if (circuit_state['last_failure_time'] and 
                current_time - circuit_state['last_failure_time'] >= self.reset_timeout):
            ...
            if (circuit_state['half_open_start_time'] and 
                current_time - circuit_state['half_open_start_time'] >= self.half_open_timeout):
