...
class TestInjectableDecorator:
    ...
    def test_injectable_with_defaults(self):
        ...
        class ServiceWithDefaults:
            def __init__(self, port: MockPort, default_param: str = "default", service: Optional[MockService] = None):
                self.port = port
    ...
    def test_injectable_info_extraction(self):
        ...
        class InfoMockService:
            def __init__(self, port: MockPort, optional: Optional[MockService] = None, manual: str = "default"):
                self.port = port
...
class TestInjectableIntegration:
    ...
    def test_injectable_command_bus_pattern(self):
        ...
        class TestCommandBus:
            def __init__(self, logger: Optional[LoggingPort] = None, event_publisher: Optional[MockEventPublisher] = None):
                self.logger = logger
