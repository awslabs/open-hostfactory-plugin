...
class TestAWSProviderComprehensive:
    ...
    def get_aws_handler_modules(self):
        ...
        for handler_file in handler_files:
            try:
                module = importlib.import_module(f'src.providers.aws.infrastructure.handlers.{handler_file}')
            ...
            for class_name, handler_class in classes:
                try:
                    ...
                    if handler:
                        ...
                        has_handler_method = any(hasattr(handler, method) for method in common_methods)
    ...
    def test_aws_adapters_exist(self):
        ...
        for adapter_file in adapter_files:
            try:
                module = importlib.import_module(f'src.providers.aws.infrastructure.adapters.{adapter_file}')
...
class TestAWSTemplateInfrastructureComprehensive:
    ...
    def test_ssm_template_store_exists(self):
        ...
        try:
            from src.providers.aws.infrastructure.template.ssm_template_store import SSMTemplateStore
    ...
    def test_template_infrastructure_initialization(self):
        ...
        for module_name, class_name in template_classes:
            try:
                module = importlib.import_module(f'src.providers.aws.infrastructure.template.{module_name}')
