...
class SDKMethodDiscovery:
    ...
    def _create_method_info(self, method_name: str, handler_type: Type, 
                          handler_class: Type, operation_type: str) -> MethodInfo:
    ...
    def _create_query_method_cqrs(self, query_bus, 
                                 query_type: Type, method_info: MethodInfo) -> Callable:
    ...
    def _create_command_method_cqrs(self, command_bus, 
                                   command_type: Type, method_info: MethodInfo) -> Callable:
    ...
    def _create_query_method(self, service, 
                           query_type: Type, method_info: MethodInfo) -> Callable:
    ...
    def _create_command_method(self, service, 
                             command_type: Type, method_info: MethodInfo) -> Callable:
