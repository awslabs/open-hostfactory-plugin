...
class StorageRegistration(BaseRegistration):
    ...
    def __init__(self, type_name: str, strategy_factory: Callable, config_factory: Callable, unit_of_work_factory: Callable = None):
...
class EnhancedStorageRegistry(EnhancedBaseRegistry):
    ...
    def register(self, storage_type: str, strategy_factory: Callable, config_factory: Callable, unit_of_work_factory: Callable = None):
