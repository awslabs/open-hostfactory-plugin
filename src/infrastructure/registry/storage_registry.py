...
class StorageRegistration(BaseRegistration):
    ...
    def __init__(self, type_name: str, strategy_factory: Callable, config_factory: Callable, unit_of_work_factory: Optional[Callable] = None):
        super().__init__(type_name, strategy_factory, config_factory, unit_of_work_factory=unit_of_work_factory)
...
class StorageRegistry(BaseRegistry):
    ...
    def register(self, storage_type: str, strategy_factory: Callable, config_factory: Callable, unit_of_work_factory: Optional[Callable] = None):
        """Register storage strategy factory - implements abstract method."""
        self.register_type(storage_type, strategy_factory, config_factory, unit_of_work_factory=unit_of_work_factory)
    ...
    def register_storage(self,
        ...
        """
        try:
            self.register(storage_type, strategy_factory, config_factory, unit_of_work_factory=unit_of_work_factory)
    ...
    def _create_registration(self, type_name: str, strategy_factory: Callable, config_factory: Callable, **additional_factories) -> BaseRegistration:
        ...
        return StorageRegistration(type_name, strategy_factory, config_factory, additional_factories.get('unit_of_work_factory'))
