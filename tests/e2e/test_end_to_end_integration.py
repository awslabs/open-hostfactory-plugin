...
def test_provider_strategy_integration():
    ...
    try:
        ...
        provider_apis = [ProviderApi.SPOT_FLEET, ProviderApi.EC2_FLEET, ProviderApi.RUN_INSTANCES, ProviderApi.ASG]
        ...
        for api in provider_apis:
            try:
                ...
                if handler_method:
                    ...
                    print(f"   WARN:  {api.value} handler method not found (may use different pattern)")
...
def test_full_end_to_end_flow():
    ...
    try:
        ...
        mock_aws_client.ec2_client.request_spot_fleet.return_value = {'SpotFleetRequestId': 'sfr-12345'}
        ...
        mock_aws_ops.execute_with_standard_error_handling = Mock(side_effect=mock_execute_with_standard_error_handling)
        ...
        try:
            ...
            lt_manager.create_or_update_launch_template.assert_called_once_with(aws_template, request)
