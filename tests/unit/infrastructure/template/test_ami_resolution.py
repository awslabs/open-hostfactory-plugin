...
pytestmark = pytest.mark.skip(
    reason="AMI resolution modules moved to backup - functionality replaced by template format service"
)
...
class TestCachingAMIResolver:
    ...
    def setup_method(self):
        ...
        self.config = AMIResolutionConfig(
            enabled=True, fallback_on_failure=True, cache_enabled=True
        )
        self.resolver = CachingAMIResolver(aws_client=self.mock_aws_client, config=self.config)
...
class TestResolvingTemplateConfigurationManager:
    ...
    def setup_method(self):
        ...
        self.resolving_manager = ResolvingTemplateConfigurationManager(
            base_manager=self.mock_base_manager, ami_resolver=self.mock_ami_resolver
        )
