...
from src.providers.base.strategy.provider_strategy import (
    ProviderOperation, ProviderOperationType
)
...
class TestProviderContextIntegration:
    ...
    def test_provider_context_with_aws_strategy(self, provider_context):
        ...
        with patch('src.providers.aws.strategy.aws_provider_strategy.AWSProviderStrategy') as MockAWSStrategy:
            ...
            mock_capabilities = ProviderCapabilities(
                ...
                provider_type="test",
                features={}, limitations={}, performance_metrics={}
            )
    ...
    def test_provider_context_operation_routing(self, provider_context):
        ...
        compute_strategy.execute_operation.return_value = ProviderResult.success_result({"provider": "compute"})
        ...
        storage_strategy.execute_operation.return_value = ProviderResult.success_result({"provider": "storage"})
    ...
    def test_provider_context_failover_scenario(self, provider_context):
        ...
        from src.providers.base.strategy.provider_strategy import (
            ProviderCapabilities, ProviderResult, ProviderHealthStatus
        )
        ...
        backup_strategy.execute_operation.return_value = ProviderResult.success_result({"provider": "backup"})
