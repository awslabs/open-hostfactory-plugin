...
class TestProviderSelectionService:
    ...
    def test_default_selection_no_config_defaults(self, mock_config_manager, mock_logger, template_default):
    ...
    def test_default_selection_no_enabled_providers(self, mock_config_manager, mock_logger, template_default):
    ...
    def test_weighted_round_robin_selection(self, mock_config_manager, mock_logger):
        ...
        assert "aws-light" in selections or selections.count("aws-heavy") > selections.count("aws-light")
