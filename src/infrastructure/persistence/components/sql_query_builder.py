...
class SQLQueryBuilder(QueryManager):
    ...
    def build_read_query(self, entity_id: Optional[str] = None, criteria: Optional[Dict[str, Any]] = None, **kwargs) -> Tuple[str, Dict[str, Any]]:
    ...
    def build_update_query(self, data: Dict[str, Any], entity_id: str, id_column: str = 'id', **kwargs) -> Tuple[str, Dict[str, Any]]:
