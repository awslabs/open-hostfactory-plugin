...
class AWSMachineAdapter:
    ...
    def create_machine_from_aws_instance(self, 
        ...
        try:
            ...
            required_fields = ['InstanceId', 'State', 'InstanceType', 'PrivateIpAddress', 'Placement', 'SubnetId', 'VpcId', 'ImageId']
            ...
            machine_data = {
                ...
                "price_type": PriceType.SPOT.value if aws_instance_data.get('InstanceLifecycle') == 'spot' 
        ...
        try:
            ...
            try:
                ...
                if error_code == 'InvalidInstanceID.NotFound':
                    ...
                    raise AWSError(f"AWS error during health check: {str(e)}", error_code=error_code)
            ...
            self._logger.debug(f"Health check completed for {machine.machine_id}: system={system_status}, instance={instance_health}")
            return health_checks
        ...
        try:
            ...
            try:
                ...
                if error_code == 'InvalidInstanceID.NotFound':
                    ...
                    raise AWSError(f"AWS error getting machine details: {str(e)}", error_code=error_code)
