...
class AWSRequestAdapter(RequestAdapterPort):
    ...
    def get_request_status(self, request: Request) -> Dict[str, Any]:
        ...
        if not request.resource_id:
            return {
                'status': 'unknown',
                'message': 'No resource ID available'
            }
    ...
    def _get_asg_status(self, request: Request) -> Dict[str, Any]:
        ...
        try:
            ...
            return {
                'status': 'error',
                'message': f"Failed to get ASG status: {str(e)}"
            }
    ...
    def _get_run_instances_status(self, request: Request) -> Dict[str, Any]:
        ...
        """
        try:
            # For RunInstances, the resource_id is a comma-separated list of instance IDs
            if not request.resource_id:
                return {
                    'status': 'error',
                    'message': 'No resource ID available'
    ...
    def _get_return_request_status(self, request: Request) -> Dict[str, Any]:
        ...
        """
        try:
            # For return requests, the resource_id is a comma-separated list of instance IDs
            if not request.resource_id:
                return {
                    'status': 'error',
                    'message': 'No resource ID available'
