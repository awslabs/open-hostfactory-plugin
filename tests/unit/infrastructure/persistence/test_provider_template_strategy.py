...
class TestProviderTemplateStrategy:
    ...
    def test_discover_template_files(self, temp_dir, mock_config_manager, sample_templates):
        ...
        main_file, aws_file, instance_file, legacy_file = self.create_template_files(temp_dir, sample_templates)
    ...
    def test_refresh_cache(self, temp_dir, mock_config_manager):
        ...
        # Create initial file
        with open(main_file, 'w') as f:
            json.dump([{"template_id": "initial", "image_id": "ami-1", "subnet_ids": ["subnet-1"], "max_instances": 1}], f)
        ...
        with open(new_file, 'w') as f:
            json.dump([{"template_id": "new", "image_id": "ami-2", "subnet_ids": ["subnet-2"], "max_instances": 1}], f)
