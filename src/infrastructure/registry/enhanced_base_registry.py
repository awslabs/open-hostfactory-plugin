"""Enhanced base registry supporting both single-choice and multi-choice patterns."""
...
class EnhancedBaseRegistry(ABC):
    """Enhanced base registry supporting both single-choice and multi-choice patterns."""
    
    _instances: Dict[str, 'EnhancedBaseRegistry'] = {}
    ...
    def __init__(self, mode: RegistryMode = RegistryMode.SINGLE_CHOICE):
        ...
        self._instance_registrations: Dict[str, BaseRegistration] = {}  # Instance-based registrations (multi-choice only)
    ...
    @abstractmethod
    def register(self, type_name: str, strategy_factory: Callable, config_factory: Callable, **kwargs):
    ...
    def register_type(self, 
        ...
        with self._registry_lock:
            ...
            registration = self._create_registration(type_name, strategy_factory, config_factory, **additional_factories)
    ...
    def _get_instance_registration(self, instance_name: str) -> BaseRegistration:
        ...
        with self._registry_lock:
            if instance_name not in self._instance_registrations:
                ...
                raise ValueError(f"Instance '{instance_name}' is not registered. Available instances: {available_instances}")
