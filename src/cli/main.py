...
For more information, visit: https://github.com/aws-samples/open-hostfactory-plugin
    ...
    parser.add_argument('--scheduler', choices=['default', 'hostfactory', 'hf'], 
    ...
    machines_request.add_argument('template_id', nargs='?', help='Template ID to use (optional if using -f/--file or -d/--data)')
    machines_request.add_argument('machine_count', nargs='?', type=int, help='Number of machines to request (optional if using -f/--file or -d/--data)')
    ...
    providers_list.add_argument('--format', choices=['json', 'yaml', 'table', 'list'], 
                               help='Output format')
    ...
    providers_show.add_argument('--format', choices=['json', 'yaml', 'table', 'list'], 
                               help='Output format')
    ...
    providers_health.add_argument('--format', choices=['json', 'yaml', 'table', 'list'], 
                                 help='Output format')
    ...
    providers_metrics.add_argument('--format', choices=['json', 'yaml', 'table', 'list'], 
                                  help='Output format')
    ...
    storage_list.add_argument('--format', choices=['json', 'yaml', 'table', 'list'], 
                             help='Output format')
    
    # Storage show
    storage_show = storage_subparsers.add_parser('show', help='Show current storage configuration')
    storage_show.add_argument('--format', choices=['json', 'yaml', 'table', 'list'], 
                             help='Output format')
    ...
    storage_health.add_argument('--format', choices=['json', 'yaml', 'table', 'list'], 
                               help='Output format')
    ...
    storage_metrics.add_argument('--format', choices=['json', 'yaml', 'table', 'list'], 
                                help='Output format')
    ...
    scheduler_list.add_argument('--format', choices=['json', 'yaml', 'table', 'list'], 
                               help='Output format')
    ...
    scheduler_show.add_argument('--format', choices=['json', 'yaml', 'table', 'list'], 
                               help='Output format')
    ...
    scheduler_validate.add_argument('--format', choices=['json', 'yaml', 'table', 'list'], 
                                   help='Output format')
    ...
    mcp_tools_list.add_argument('--format', choices=['json', 'yaml', 'table'], 
                               default='table', help='Output format')
    mcp_tools_list.add_argument('--type', choices=['command', 'query'], 
                               help='Filter tools by handler type')
    ...
    mcp_tools_call.add_argument('--format', choices=['json', 'yaml', 'table'], 
                               default='json', help='Output format')
    ...
    mcp_tools_info.add_argument('--format', choices=['json', 'yaml', 'table'], 
                               default='table', help='Output format')
    ...
    mcp_validate.add_argument('--format', choices=['json', 'yaml', 'table'], 
                             default='table', help='Output format')
    ...
    mcp_serve.add_argument('--log-level', choices=['DEBUG', 'INFO', 'WARNING', 'ERROR'], 
                          default='INFO', help='Logging level for MCP server')
    ...
    try:
        ...
        try:
            ...
            if e.code == 2 and len(sys.argv) >= 2 and 'required: action' in error_output:
                ...
                if resource_name in ['templates', 'machines', 'requests', 'system', 'config', 'providers', 'storage', 'scheduler']:
