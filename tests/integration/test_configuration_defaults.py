...
def test_template_defaults_integration():
    ...
    try:
        from src.infrastructure.persistence.repositories.template_repository import TemplateSerializer
...
def test_template_defaults_precedence():
    ...
    try:
        ...
        assert template.subnet_ids == ['subnet-explicit-123'], "Explicit subnet_ids should be preserved"
        assert template.security_group_ids == ['sg-explicit-456'], "Explicit security_group_ids should be preserved"
