...
class ProviderRegistration(BaseRegistration):
    ...
    def __init__(self, type_name: str, strategy_factory: Callable, config_factory: Callable, 
                 resolver_factory: Callable = None, validator_factory: Callable = None):
...
class EnhancedProviderRegistry(EnhancedBaseRegistry):
    ...
    def register_provider_instance(self, provider_type: str, instance_name: str, 
                                  strategy_factory: Callable, config_factory: Callable,
                                  resolver_factory: Callable = None, validator_factory: Callable = None):
...
def example_usage():
    ...
    registry.register("aws", aws_strategy_factory, aws_config_factory, aws_resolver_factory, aws_validator_factory)
