...
class TestConfigurationIntegration:
    ...
    def test_configuration_validation_integration(self):
        ...
        invalid_configs = [
            {
                "provider": {
                    "type": "invalid_provider"  # Invalid provider type
                }
            },
            {
                "provider": {
...
class TestEventSystemIntegration:
    ...
    def test_event_sourcing_integration(self):
        ...
        def mock_get_events(aggregate_id):
            ...
            return [
                entry['event'] for entry in stored_events 
        ...
        timestamps = [entry['timestamp'] for entry in stored_events if entry['aggregate_id'] == request_id]
