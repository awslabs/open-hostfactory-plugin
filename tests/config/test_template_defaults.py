...
class TestTemplateDefaultsService:
    ...
    def test_resolve_template_defaults_hierarchy(self, template_defaults_service, mock_config_manager, sample_provider_config, sample_template_config):
    ...
    def test_resolve_template_defaults_no_provider_instance(self, template_defaults_service, mock_config_manager, sample_provider_config, sample_template_config):
    ...
    def test_resolve_provider_api_default_hierarchy(self, template_defaults_service, mock_config_manager, sample_provider_config, sample_template_config):
        ...
        result = template_defaults_service.resolve_provider_api_default(template_dict, 'aws-primary')
        ...
        result = template_defaults_service.resolve_provider_api_default(template_dict, 'aws-secondary')
        assert result == 'EC2Fleet'  # From provider type defaults
    
    def test_get_effective_template_defaults(self, template_defaults_service, mock_config_manager, sample_provider_config, sample_template_config):
    ...
    def test_validate_template_defaults(self, template_defaults_service, mock_config_manager, sample_provider_config, sample_template_config):
    ...
    def test_provider_type_extraction(self, template_defaults_service, mock_config_manager, sample_provider_config):
    ...
    def test_none_value_handling(self, template_defaults_service, mock_config_manager, sample_provider_config, sample_template_config):
...
class TestTemplateDefaultsIntegration:
    ...
    def test_scheduler_strategy_integration(self):
        ...
        from src.infrastructure.scheduler.strategies.symphony_hostfactory import SymphonyHostFactorySchedulerStrategy
        ...
        scheduler = SymphonyHostFactorySchedulerStrategy(
            mock_config_manager, 
            mock_logger, 
            mock_template_defaults_service
        )
        ...
        mock_template_defaults_service.resolve_provider_api_default.assert_called_once_with(template_dict)
