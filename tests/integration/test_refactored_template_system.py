...
from src.infrastructure.template.template_cache_service import (
    TTLTemplateCacheService, NoOpTemplateCacheService, create_template_cache_service
)
from src.infrastructure.template.services.template_persistence_service import TemplatePersistenceService
...
class TestRefactoredTemplateSystem:
    ...
    @pytest.mark.asyncio
    async def test_persistence_service_operations(self, mock_scheduler_strategy, mock_logger, sample_template_dto):
    ...
    @pytest.mark.asyncio
    async def test_configuration_manager_orchestration(self, mock_config_manager, mock_scheduler_strategy, mock_logger):
    ...
    @pytest.mark.asyncio
    async def test_configuration_manager_caching(self, mock_config_manager, mock_scheduler_strategy, mock_logger):
    ...
    @pytest.mark.asyncio
    async def test_configuration_manager_validation(self, mock_config_manager, mock_scheduler_strategy, mock_logger, sample_template_dto):
    ...
    def test_configuration_manager_cache_management(self, mock_config_manager, mock_scheduler_strategy, mock_logger):
    ...
    @pytest.mark.asyncio
    async def test_aws_template_adapter_integration(self, mock_config_manager, mock_scheduler_strategy, mock_logger):
    ...
    def test_service_dependency_injection(self, mock_config_manager, mock_scheduler_strategy, mock_logger):
    ...
    @pytest.mark.asyncio
    async def test_error_handling_and_resilience(self, mock_config_manager, mock_scheduler_strategy, mock_logger):
    ...
    def test_backward_compatibility(self, mock_config_manager, mock_scheduler_strategy, mock_logger):
        ...
        with patch.object(config_manager, 'get_template_by_id', new_callable=AsyncMock) as mock_async:
