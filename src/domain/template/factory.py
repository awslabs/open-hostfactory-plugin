...
class TemplateFactoryPort(Protocol):
    ...
    def create_template(self, 
                       ...
                       provider_type: Optional[str] = None) -> Template:
...
class TemplateFactory(BaseTemplateFactory):
    ...
    def _determine_provider_type(self, template_data: Dict[str, Any]) -> Optional[str]:
        ...
        aws_specific_fields = {
            'provider_api', 'fleet_type', 'fleet_role', 'spot_fleet_request_expiry',
            'allocation_strategy', 'volume_type', 'iops', 'ami_resolution'
        }
    ...
    def create_template_with_extensions(self, 
                                      template_data: Dict[str, Any], 
                                      provider_type: Optional[str] = None,
                                      extension_data: Optional[Dict[str, Any]] = None) -> Template:
...
def create_template_factory(extension_registry: Optional[TemplateExtensionRegistry] = None,
                          logger: Optional[LoggingPort] = None) -> TemplateFactory:
