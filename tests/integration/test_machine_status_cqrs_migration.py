...
class TestMachineStatusCQRSMigration:
    ...
    def test_handler_can_handle_methods(self, convert_handler, batch_convert_handler, validate_handler):
        ...
        validate_command = ValidateProviderStateCommand(provider_state="running", provider_type="aws")
