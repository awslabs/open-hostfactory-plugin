...
class TestGetRequestStatusFunctionality:
    ...
    def test_hostfactory_format_basic(self, scheduler_strategy):
        ...
        result = scheduler_strategy.convert_domain_to_hostfactory_output('getRequestStatus', mock_dto)
    ...
    def test_dict_input_fallback(self, scheduler_strategy):
        ...
        result = scheduler_strategy.convert_domain_to_hostfactory_output('getRequestStatus', dict_data)
