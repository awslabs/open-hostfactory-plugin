...
from src.domain.base.events import (
    DomainEvent, RepositoryOperationStartedEvent, RepositoryOperationCompletedEvent,
    RepositoryOperationFailedEvent, SlowQueryDetectedEvent
)
...
class RequestRepositoryImpl(RequestRepositoryInterface):
    ...
    def save(self, request: Request) -> List[Any]:
        ...
        self._publish_persistence_event(RepositoryOperationStartedEvent(
        ...
        try:
            ...
            self._publish_persistence_event(RepositoryOperationCompletedEvent(
                aggregate_id=operation_id,
                aggregate_type="RepositoryOperation",
                operation_id=operation_id,
                entity_type="Request",
            ...
            if duration_ms > self.slow_query_threshold_ms:
                self._publish_persistence_event(SlowQueryDetectedEvent(
                    aggregate_id=operation_id,
            ...
            self._publish_persistence_event(RepositoryOperationFailedEvent(
                aggregate_id=operation_id,
                aggregate_type="RepositoryOperation",
                operation_id=operation_id,
                entity_type="Request",
