...
class TestEndToEndDryRun:
    ...
    def setup_method(self):
        ...
        self.provisioning_adapter.provision_resources = Mock(wraps=self.provisioning_adapter.provision_resources)
        self.provisioning_adapter._provision_via_strategy = Mock(wraps=self.provisioning_adapter._provision_via_strategy)
        self.provisioning_adapter._provision_via_handlers = Mock(wraps=self.provisioning_adapter._provision_via_handlers)
