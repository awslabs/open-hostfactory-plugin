...
from src.domain.base.provider_interfaces import (
    ProviderType, ProviderInstanceState, ProviderResourceTag, ProviderResourceIdentifier,
    ProviderLaunchTemplate, ProviderStateMapper, ProviderResourceValidator
)
...
class AWSProviderAdapter:
    ...
    def create_resource_identifier(self, resource_type: str, identifier: str,
                                 region: Optional[str] = None) -> ProviderResourceIdentifier:
    ...
    def create_launch_template(self, template_id: str,
                             version: Optional[str] = None) -> ProviderLaunchTemplate:
