...
class HandlerDiscoveryError(SDKError):
    ...
    def __init__(self, message: str, handler_type: Optional[str] = None, details: Optional[Dict[str, Any]] = None):
        super().__init__(message, details)
...
class MethodExecutionError(SDKError):
    ...
    def __init__(self, message: str, method_name: Optional[str] = None, details: Optional[Dict[str, Any]] = None):
        super().__init__(message, details)
