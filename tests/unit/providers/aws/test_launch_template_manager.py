...
from src.providers.aws.infrastructure.launch_template.manager import AWSLaunchTemplateManager, LaunchTemplateResult
...
class TestAWSLaunchTemplateManager:
    ...
    def test_create_or_update_launch_template_per_request_disabled(self):
        ...
        self.mock_aws_client.ec2_client.describe_launch_templates.return_value = mock_describe_response
