...
from src.domain.machine.value_objects import (
    MachineId, MachineStatus, MachineConfiguration, MachineType
)
from src.domain.machine.exceptions import (
    MachineValidationError, MachineNotFoundError, 
    InvalidMachineStateError, MachineProvisioningError
)
from src.domain.base.value_objects import (
    InstanceId, InstanceType, IPAddress, Tags
)
...
class TestMachineAggregate:
    ...
    def test_machine_network_configuration(self):
        ...
        assert machine.network_configuration.public_dns_name == "ec2-54-123-45-67.compute-1.amazonaws.com"
    ...
    def test_machine_validation_required_fields(self):
        ...
        required_fields = [
            "id", "instance_id", "template_id", "request_id", 
            "status", "instance_type", "availability_zone"
        ]
