...
class AWSLaunchTemplateManager:
    ...
    def _create_new_launch_template(self, template_name: str, template_data: Dict[str, Any], 
                                  client_token: str, request: Request, aws_template: AWSTemplate) -> LaunchTemplateResult:
        """
    ...
    def _create_launch_template_data(self, aws_template: AWSTemplate, request: Request) -> Dict[str, Any]:
        ...
        launch_template_data = {
            'ImageId': image_id,
            'InstanceType': aws_template.instance_type if aws_template.instance_type else list(aws_template.instance_types.keys())[0],
            'TagSpecifications': [{
