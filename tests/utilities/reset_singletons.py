...
def reset_all_singletons() -> None:
    ...
    _safe_reset_class_instance('src.infrastructure.patterns.singleton_registry', 'SingletonRegistry')
    
    # Reset any global singleton instances
    # This is for backward compatibility with old singleton implementations
    _safe_reset_global_variable('src.infrastructure.aws.aws_client_singleton', '_aws_client_singleton_instance')
