...
class TestMultiInstanceProviderSupport:
    ...
    def test_provider_registry_duplicate_instance_error(self):
        ...
        with pytest.raises(ValueError, match="Provider instance 'aws-us-east-1' is already registered"):
            registry.register_provider_instance(
                provider_type="aws",
    ...
    def test_multi_instance_registration_flow(self):
        ...
        with patch('src.infrastructure.di.provider_services.get_config_manager', return_value=mock_config_manager), \
    ...
    def test_provider_strategy_factory_with_instances(self):
        ...
        with patch('src.infrastructure.factories.provider_strategy_factory.get_provider_registry', return_value=mock_registry):
            ...
            mock_registry.create_strategy_from_instance.assert_called_once_with("aws-us-east-1", provider_config)
