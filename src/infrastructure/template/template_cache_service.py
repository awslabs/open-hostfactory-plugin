...
class AutoRefreshTemplateCacheService(TTLTemplateCacheService):
    ...
    def __init__(self, ttl_seconds: int = 300, auto_refresh: bool = False, logger: LoggingPort = None):
        """
...
def create_template_cache_service(cache_type: str = "noop", logger: LoggingPort = None, **kwargs) -> TemplateCacheService:
    """
