...
class TestListSchedulerStrategiesHandler:
    ...
    async def test_list_strategies_basic(self, handler, mock_registry, mock_config_manager):
        ...
        with patch('src.infrastructure.registry.scheduler_registry.get_scheduler_registry', return_value=mock_registry), \
...
class TestGetSchedulerConfigurationHandler:
    ...
    async def test_get_current_configuration(self, handler, mock_config_manager, mock_registry):
        ...
        with patch('src.config.manager.ConfigurationManager', return_value=mock_config_manager), \
             patch('src.infrastructure.registry.scheduler_registry.get_scheduler_registry', return_value=mock_registry):
    ...
    @pytest.mark.asyncio
    async def test_get_configuration_not_registered(self, handler, mock_config_manager, mock_registry):
...
class TestValidateSchedulerConfigurationHandler:
    ...
    @pytest.mark.asyncio
    async def test_validate_unregistered_scheduler(self, handler, mock_config_manager, mock_registry):
    ...
    @pytest.mark.asyncio
    async def test_validate_strategy_creation_failure(self, handler, mock_config_manager, mock_registry):
