...
from src.infrastructure.registry.base_registry import (
    BaseRegistry, RegistryMode, BaseRegistration
)
...
class TestUnifiedBaseRegistry:
    ...
    def test_provider_registry_multi_choice_mode(self):
        ...
        registry.register_provider_instance("aws", "aws-primary", self.mock_strategy_factory, self.mock_config_factory)
        registry.register_provider_instance("aws", "aws-secondary", self.mock_strategy_factory, self.mock_config_factory)
        ...
        instance_strategy = registry.create_strategy_from_instance("aws-primary", {"config": "instance"})
