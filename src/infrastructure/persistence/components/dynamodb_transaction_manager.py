...
class DynamoDBTransactionManager(TransactionManager):
    ...
    def add_put_item(self, table_name: str, item: Dict[str, Any], 
    ...
    def add_update_item(self, table_name: str, key: Dict[str, Any], 
    ...
    def add_delete_item(self, table_name: str, key: Dict[str, Any],
                       condition_expression: Optional[str] = None) -> None:
        """
    ...
    def commit_transaction(self) -> None:
        ...
        try:
            ...
            self.state = TransactionState.COMMITTED
            self.logger.debug(f"DynamoDB transaction committed with {len(self.transaction_items)} operations")
