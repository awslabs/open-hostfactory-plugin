...
class TestSDKMethodDiscovery:
    ...
    def test_command_to_method_name(self):
        ...
        assert discovery._command_to_method_name(UpdateMachineStatusCommand) == "update_machine_status"
    ...
    async def test_discover_sdk_methods_success(self):
        ...
        with patch('src.sdk.discovery.get_registered_query_handlers', return_value=mock_query_handlers):
            with patch('src.sdk.discovery.get_registered_command_handlers', return_value=mock_command_handlers):
    ...
    async def test_discover_sdk_methods_failure(self):
        ...
        with patch('src.sdk.discovery.get_registered_query_handlers', side_effect=Exception("Registry error")):
