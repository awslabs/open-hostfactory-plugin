...
class TestBootstrapIntegration:
    ...
    def test_application_initialization_with_unified_config(self, mock_setup_logging, mock_get_config_manager, mock_register_services):
        ...
        from src.config.schemas.provider_strategy_schema import UnifiedProviderConfig, ProviderInstanceConfig
    ...
    @patch('src.bootstrap.get_config_manager')
    @patch('src.bootstrap.setup_logging')
    def test_application_initialization_with_legacy_config(self, mock_setup_logging, mock_get_config_manager, mock_register_services):
        ...
        self.mock_config_manager.get_unified_provider_config.side_effect = AttributeError("Method not available")
    ...
    @patch('src.bootstrap.register_services')
    @patch('src.bootstrap.get_config_manager')
    def test_application_initialization_failure(self, mock_get_config_manager, mock_register_services):
    ...
    @patch('src.bootstrap.get_config_manager')
    @patch('src.bootstrap.setup_logging')
    def test_get_provider_info_integration(self, mock_setup_logging, mock_get_config_manager, mock_register_services):
    ...
    @patch('src.bootstrap.get_config_manager')
    @patch('src.bootstrap.setup_logging')
    def test_context_manager_integration(self, mock_setup_logging, mock_get_config_manager, mock_register_services):
    ...
    @patch('src.bootstrap.register_services')
    @patch('src.bootstrap.get_config_manager')
    def test_context_manager_initialization_failure(self, mock_get_config_manager, mock_register_services):
