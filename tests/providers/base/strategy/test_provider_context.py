...
from src.providers.base.strategy.provider_strategy import (
    ProviderStrategy, ProviderOperation, ProviderResult, 
    ProviderCapabilities, ProviderHealthStatus, ProviderOperationType
)
...
class TestProviderContext:
    ...
    def test_register_duplicate_strategy(self, provider_context, mock_logger):
        ...
        mock_logger.warning.assert_called_with("Strategy same-provider already registered, replacing")
    ...
    def test_execute_operation_unsupported(self, provider_context):
        ...
        strategy = MockProviderStrategy("test-provider", supports_operations=[ProviderOperationType.GET_INSTANCE_STATUS])
        provider_context.register_strategy(strategy)
    ...
    def test_strategy_metrics_recording(self, provider_context):
        ...
        strategy = MockProviderStrategy("test-provider", supports_operations=[
