...
class RequestType(str, Enum):
    ...
    def to_operation_type(self) -> str:
        ...
        """
        mapping = {
            RequestType.ACQUIRE: "provision",
            RequestType.RETURN: "terminate"
        }
        return mapping[self]
...
class RequestStatus(str, Enum):
    ...
    def is_terminal(self) -> bool:
        ...
        return self in [RequestStatus.COMPLETED, RequestStatus.FAILED, RequestStatus.CANCELLED, RequestStatus.TIMEOUT]
    ...
    def can_transition_to(self, new_status: 'RequestStatus') -> bool:
        ...
        valid_transitions = {
            ...
            RequestStatus.IN_PROGRESS: [RequestStatus.COMPLETED, RequestStatus.FAILED, RequestStatus.CANCELLED, RequestStatus.TIMEOUT],
