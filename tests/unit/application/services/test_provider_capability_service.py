...
class TestProviderCapabilityService:
    ...
    def test_validate_template_requirements_high_instance_count(self, service, template_high_instance_count):
        """Test validation with instance count exceeding API limits."""
        result = service.validate_template_requirements(
            template_high_instance_count,
            "aws-us-east-1",
            ValidationLevel.STRICT
        )
    ...
    def test_validate_template_requirements_fleet_type_support(self, service, template_with_fleet_type):
        """Test validation of fleet type support."""
        result = service.validate_template_requirements(
            template_with_fleet_type,
            "aws-us-east-1",
            ValidationLevel.STRICT
        )
