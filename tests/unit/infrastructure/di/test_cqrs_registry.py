...
class TestCQRSHandlerRegistry:
    ...
    def test_get_stats(self):
        ...
        self.registry.register_event_handler(TestEvent1, TestEventHandler2)  # Multiple handlers for same event
    ...
    def test_thread_safety(self):
        ...
        def register_handlers(thread_id: int):
            try:
                ...
                # Verify registrations
                if (self.registry.has_command_handler(f"Command_{thread_id}") and
                    self.registry.has_query_handler(f"Query_{thread_id}") and
                    self.registry.has_event_handlers(f"Event_{thread_id}")):
