...
from src.domain.request.exceptions import (
    RequestValidationError, RequestNotFoundError, 
    InvalidRequestStateError, RequestProcessingError
)
...
class TestRequestAggregate:
    ...
    def test_request_progress_tracking(self):
        ...
        request.update_progress(
            completed_count=2,
            status_message="2 out of 5 machines provisioned"
        )
        ...
        request.update_progress(
            completed_count=5,
            status_message="All machines provisioned"
        )
