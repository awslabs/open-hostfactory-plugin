...
class TestDIContainer:
    ...
    def test_injectable_class_registration(self):
        ...
        with patch('src.infrastructure.di.components.dependency_resolver.is_injectable', return_value=True):
            with patch('src.infrastructure.di.components.dependency_resolver.get_injectable_metadata', return_value=None):
...
class TestDIContainerIntegration:
    ...
    def test_mixed_registration_types(self):
        ...
        class CompositeService:
            def __init__(self, singleton: SingletonService, factory: FactoryService, instance: InstanceService):
