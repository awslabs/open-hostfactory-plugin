...
class TestLoggingFixes:
    ...
    def test_no_duplicate_ssm_resolution(self, mock_ami_resolver):
        ...
        with LogCapture() as log_capture:
            ...
            template_dicts = [
                {'template_id': 'template1', 'imageId': '/aws/service/ami-amazon-linux-latest/al2023-ami-kernel-6.1-x86_64'},
                {'template_id': 'template2', 'imageId': '/aws/service/ami-amazon-linux-latest/al2023-ami-kernel-6.1-x86_64'},
                {'template_id': 'template3', 'imageId': '/aws/service/ami-amazon-linux-latest/al2023-ami-kernel-6.1-x86_64'},
            ]
    ...
    def test_correct_provider_mode_detection(self, mock_provider_context):
        ...
        with LogCapture() as log_capture:
            ...
            def get_provider_info():
                ...
                return {
                    "mode": "multi" if len(mock_provider_context.available_strategies) > 1 else "single",
    ...
    def test_no_template_preloading_in_bootstrap(self, mock_config_manager):
        ...
        with LogCapture() as log_capture:
            ...
            template_preload_messages = log_capture.count_messages_containing("Preloading templates")
    ...
    def test_application_service_provider_info_structure(self, mock_provider_context):
        ...
        # Verify structure
        required_keys = ['mode', 'current_strategy', 'available_strategies', 'provider_names', 'provider_count', 'status']
...
class TestLoggingRegression:
    ...
    def test_health_check_error_regression(self):
        ...
        with LogCapture() as log_capture:
            ...
            strategies = {
                'aws-aws-primary': Mock(),
                'aws-aws-secondary': Mock()
            }
